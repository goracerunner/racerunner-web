      ...
      <Container>
        ...
        <div className={classes.section}>
          ...
          <Typography variant="body2" className={classes.paragraph}>
            This Privacy Policy is designed to help you understand how your data
            is collected, used and disclosed by the <em>Race Runner</em>{" "}
            website, and applies to content and data that is collected, used and
            disclosed by the <em>Race Runner</em> website, located at{" "}
          ...
          <Typography variant="body2" className={classes.paragraph}>
            This platform's intention is solely to provide a service with which
            can run a social event where participants, as individuals or teams,
            perform a series of challenges and collect points through various
            means through the application.
          </Typography>
          <Typography variant="body2" className={classes.paragraph}>
          ...
          <Typography variant="body2" className={classes.paragraph}>
            ...
            this Privacy Policy acts in accordance with the Terms of Use, which
            you agree to when you use this Site.
          </Typography>
        </div>
        <div className={classes.section}>
          <Typography variant="h6" className={classes.heading}>
          ...
          <ul>
            ...
            <li>measure and improve the functionality provided by this Site</li>
            <li>provide you with support and to respond to your enquiries</li>
          </ul>
          <Typography variant="body2" className={classes.paragraph}>
            The information we collect on this Site will never be given or sold
            to third parties. We will never use information you provide to us to
            deliver marketing or promotional materials to you.
          </Typography>
        </div>
        <div className={classes.section}>
          <Typography variant="h6" className={classes.heading}>
          ...
          <Typography variant="body2" className={classes.paragraph}>
            ...
            Information we hold about you from loss, theft and unauthorised use,
          ...
          <Typography variant="body2" className={classes.paragraph}>
            ...
            the purposes of running a <em>Race Runner</em> event. By using this
            Site, you are allowing the disclosure of such information by us. See
            the{" "}
        ...
        <div className={classes.section}>
          ...
          <Typography variant="body2" className={classes.paragraph}>
            If you would like to access, review, correct or update your Personal
        ...
        <div className={classes.section}>
          ...
          <Typography variant="body2" className={classes.paragraph}>
            <b>Updates to Privacy Policy.</b> We may modify this Privacy Policy
            at any time. The date at the top of this Privacy Policy tells you
            when it was last updated. Any changes to this Privacy Policy become
            effective when we publish it online. If you do not agree with
            changes to this Privacy Policy, you may terminate your account with
            us.
          </Typography>
          <Typography variant="body2" className={classes.paragraph}>
            <b>Location of Data.</b> Some parts of the Site and data are hosted
            in and managed outside of Australia. In using this Site, you consent
            to this practice, understanding that your Personal Information may
            be accessible from or transmitted outside Australia.
          </Typography>
        </div>
        <div className={classes.section}>
          <Typography variant="h6" className={classes.heading}>

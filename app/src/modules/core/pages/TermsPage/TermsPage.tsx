      ...
      <Container>
        ...
        <div className={classes.section}>
          ...
          <Typography variant="body2" className={classes.paragraph}>
            ...
            these Terms of Use tell you when it was last updated. Any changes to
            these Terms of Use become effective when we publish it online. By
            accessing this Site and using its services, you accept and agree to
            the currently published revision of the Terms of Use.
          </Typography>
        </div>
        <div className={classes.section}>
          <Typography variant="h6" className={classes.heading}>
          ...
          <Typography variant="body2" className={classes.paragraph}>
            The content available on this Site is soley to be used for running a{" "}
            <em>Race Runner</em> event, which is a social event which requires
            participants (as teams or individuals) to complete activities and
            enter data into this website for tracking progress and results.
          </Typography>
          <Typography variant="body2" className={classes.paragraph}>
        ...
        <div className={classes.section}>
          ...
          <Typography variant="body2" className={classes.paragraph}>
            ...
            responsibility. You are liable for all actions performed on the Site
            using your credentials.
          </Typography>
          <Typography variant="body2" className={classes.paragraph}>
            It is your responsibility to protect the password and access to your
            account to the best of your ability. Failure to do so is a violation
